...
VALUES (1,0,'用户管理',0,'0/','user2:view','menu','user2/userList');
INSERT INTO `sys_permission` (`permission_id`,`available`,`permission_name`,`parent_id`,`parent_ids`,`permission`,`resource_type`,`url`)
VALUES (2,0,'用户添加',1,'0/1','user2:add','button','user2/userAdd');
INSERT INTO `sys_permission` (`permission_id`,`available`,`permission_name`,`parent_id`,`parent_ids`,`permission`,`resource_type`,`url`)
VALUES (3,0,'用户删除',1,'0/1','user2:del','button','user2/userDel');
